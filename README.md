...
|---|---|---|
| **LLM** | Mistral 7B (Ollama) | Génération de réponses locales |
...
| **Embeddings** | `nomic-embed-text` (Ollama) | Vectorisation des documents |
...
| **Audio** | Whisper (Local) | Transcription vocale pour dictée médicale |
